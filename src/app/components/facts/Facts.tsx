    ...
    return (
        <div className="container-fluid facts py-5 pt-lg-0">
            <div className="container py-5 pt-lg-0">
                <div className="row gx-0" style={{maxWidth: '800px', margin: '0 auto'}}>
                    <div className="col-lg-6 wow zoomIn" data-wow-delay="0.1s">
                        <div className="bg-primary shadow d-flex align-items-center justify-content-center p-4" style={{ height: "150px" }}>
                            ...
                            <div className="ps-4">
                                <h5 className="text-white mb-0">Proyectos</h5>
                                <h1 className="text-white mb-0" data-toggle="counter-up"><CountUp end={100} duration={5}/></h1>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-6 wow zoomIn" data-wow-delay="0.3s">
                        <div className="bg-light shadow d-flex align-items-center justify-content-center p-4" style={{ height: "150px" }}>
                            ...
                            <div className="ps-4">
                                <h5 className="text-primary mb-0">Sesiones</h5>
                                <h1 className="mb-0 text-primary"><CountUp end={19} duration={5}/></h1>
                            </div>
                        </div>
                    </div>
                </div>
